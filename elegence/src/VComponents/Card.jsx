...
<Breadcrumb fontSize={"20px"} color={"gray"} pb={"40px"}>
  <BreadcrumbItem>
    <BreadcrumbLink href='/cart'>Review</BreadcrumbLink>
  </BreadcrumbItem>

  <BreadcrumbItem>
    <BreadcrumbLink href='/checkout' >Ship</BreadcrumbLink>
  </BreadcrumbItem>

  <BreadcrumbItem isCurrentPage>
    <BreadcrumbLink href='/pay' color={"teal"} fontWeight={"bold"}>Payment</BreadcrumbLink>
  </BreadcrumbItem>
</Breadcrumb>
