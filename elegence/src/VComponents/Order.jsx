    ...
    <Box p={"40px"}>
      ...
      <Box border={"1px solid #8888"} p={"30px"} color={"gray.600"}>
        ...
        <Flex mt={"20px"} justify={"start"} align={"center"}>
          <Text color={"gray"} mr={"8px"}>Pay now or pay later with</Text>
          <Image ml={"2px"} mr={"5px"} w={"50px"} src={"https://www.anthropologie.com/static/v3/images/klarna-logo-ea32669636986d0317f95f0c04fdcb6d.svg"} />
          <RiErrorWarningLine color='teal' />
        </Flex>
        <Flex justify={"start"} align={"center"}>
          <Text color={"gray"} mr={"8px"}>Pay with</Text>
          <Image ml={"2px"} mr={"5px"} w={"70px"} src={"https://www.anthropologie.com/static/v3/images/afterpay-logo-7904b549fb7a2a970c606efc9f1e8260.svg"} />
          <RiErrorWarningLine color='teal' />
        </Flex>
        <Box display={"grid"} mt={"15px"}>
          <Button mb={"15px"} bg={"#4B5666"} p={"25px"} letterSpacing={"0.06em"} color={"white"} borderRadius={"none"} disabled><Link to={"/checkout"}>PROCEED TO CHECKOUT</Link></Button>
